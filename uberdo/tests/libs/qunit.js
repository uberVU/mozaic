...
Test.prototype = {
	...
	run: function() {
		...
		try {
			...
			QUnit.pushFailure( "Died on test #" + (this.assertions.length + 1) + ": " + e.message, extractStacktrace( e, 1, true ) );
...
function validTest( test ) {
    ...
    // Perform lowercase comparison when filtering.
...
function extractStacktrace( e, offset, full ) {
	offset = offset || 3;
	full = full || false;
