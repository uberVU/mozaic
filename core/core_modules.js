...
App.main_modules = {
    ...
    'widget/list': 'core/base_widgets/list/list',
    'widget/list/item_management': 'core/base_widgets/list/item_management',
    'widget/list/item_params': 'core/base_widgets/list/item_params',
    'widget/list/sorting': 'core/base_widgets/list/sorting',
    'widget/list/post_process': 'core/base_widgets/list/post_process',
